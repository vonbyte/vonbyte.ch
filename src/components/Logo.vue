...
export default {
  name: 'Logo',
  props: ['wrapperClass', 'logoClass', 'additionalClass', 'hasMainHeading']
}
</script>
<style lang="scss">
    .vb-logo {
